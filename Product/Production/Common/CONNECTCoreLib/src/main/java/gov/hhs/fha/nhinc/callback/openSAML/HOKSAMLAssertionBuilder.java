...
public class HOKSAMLAssertionBuilder extends SAMLAssertionBuilder {
     ...
     * 
     * @param factory
     *            The factory object used to assist in the construction of the SAML Assertion token
     * @param issueInstant
    ...
    public static List<AttributeStatement> createEvidenceStatements(List accessConstentValues,
        ...
        List<AttributeStatement> statements = OpenSAML2ComponentBuilder.getInstance().createEvidenceStatements(
                accessConstentValues, evidenceInstanceAccessConsentValues, NHIN_NS);
